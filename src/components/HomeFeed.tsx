...
const HomeFeed = ({ onPostProblem, onProfile, onMapView }: HomeFeedProps) => {
  ...
  const myProblems = problems.filter(p => (p.postedBy || p.posted_by) === profile?.id);
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center text-xs text-gray-500 space-x-4">
                          ...
                          <div className="flex items-center">
                            ...
                            {formatTimeAgo(problem.createdAt || problem.created_at)}
                          </div>
                        </div>
                      </div>
                  ...
                  <CardContent className="pt-0">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-sm text-gray-600">
                        By {problem.postedByProfile?.fullName || 'Unknown'}
                      </div>
                    </div>

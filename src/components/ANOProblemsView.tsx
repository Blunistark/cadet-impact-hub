...
interface ANOProblemsViewProps {
  ...
  onEscalate?: (id: string, level: string, feedback: string) => void;
}

const ANOProblemsView = ({ problems, loading, showActions, onBack, onApprove, onReject, onEscalate }: ANOProblemsViewProps) => {
